...
export function buildCustomDatabaseUrl(): string | null {
  ...
  if (host || port || user || password || database) {
    console.warn("[Database] Configuração de banco de dados customizado incompleta");
    console.warn("[Database] Certifique-se de que todas as variáveis estão configuradas");
  }
