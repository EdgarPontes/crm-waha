...
export function ManusDialog({
  ...
  return (
    ...
    >
      <DialogContent className="py-5 bg-card rounded-[20px] w-[400px] shadow-[0px_4px_11px_0px_rgba(0,0,0,0.08)] border-border backdrop-blur-2xl p-0 gap-0 text-center">
        <div className="flex flex-col items-center gap-2 p-5 pt-12">
          {logo ? (
            <div className="w-16 h-16 bg-background rounded-xl border-border flex items-center justify-center">
              <img
                src={logo}
                alt="Dialog graphic"
