...
export default function NotFound() {
  ...
  return (
    <div className="min-h-screen w-full flex items-center justify-center bg-gradient-to-br from-background to-muted/60">
      <Card className="w-full max-w-lg mx-4 shadow-lg border bg-sidebar/80 backdrop-blur-sm">
